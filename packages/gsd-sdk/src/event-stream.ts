...
// ─── Generic SDK message shapes (replaces @anthropic-ai/claude-agent-sdk types) ─
...
interface SDKAPIRetryMessage extends SDKSystemMessage {
  subtype: 'api_retry';
}

interface SDKStatusMessage extends SDKSystemMessage {
  subtype: 'status';
}

interface SDKCompactBoundaryMessage extends SDKSystemMessage {
  subtype: 'compact_boundary';
}

interface SDKTaskStartedMessage extends SDKSystemMessage {
  subtype: 'task_started';
}

interface SDKTaskProgressMessage extends SDKSystemMessage {
  subtype: 'task_progress';
}

interface SDKTaskNotificationMessage extends SDKSystemMessage {
...
interface SDKResultBase extends SDKMessageBase {
  type: 'result';
  subtype: string;
...
interface SDKToolProgressMessage extends SDKMessageBase {
  type: 'tool_progress';
  tool_name: string;
  tool_use_id: string;
...
interface SDKToolUseSummaryMessage extends SDKMessageBase {
  type: 'tool_use_summary';
  summary: string;
  preceding_tool_use_ids: string[];
}

interface SDKRateLimitEvent extends SDKMessageBase {
...
interface SDKPartialAssistantMessage extends SDKMessageBase {
  type: 'stream_event';
  event: unknown;
}
